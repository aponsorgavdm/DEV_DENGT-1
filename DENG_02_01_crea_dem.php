...
<link rel="stylesheet" href="<? echo $chemin_to_racine ?>_Jquery/jqwidgets/styles/jqx.highcontrast.css" type="text/css" />
    ...
    <div id="right" class="NoShow">
        ...
        <div id="contenu-right-DENGT">
            ...
            <? if (($_SESSION['VG_Mdp_OK'] == "OUI") and ($_SESSION['VG_droits_DENGT'] =="Oui")){ ?>
				<form action="DENGT_02_Enreg_Dem_v0.1.php" method="post" name="Enreg_DENGT" id="Enreg_DENGT"  enctype="application/x-www-form-urlencoded">
					<input name="Val_Statut" id="Val_Statut" type="hidden" value="v0.3" />
					<input name="val_A0_000_idSql" id="val_A0_000_idSql" type="hidden" value="NULL" />
					...
					<div id="expandMarEtTiers" style="font-size: 12px;color: #666666;">
						...
						<div>  <!--pour expand:expandMarEtTiers-->
							<table style="border: 0px solid; background-color:#FFFFFF; padding: 0px; width:1000px; margin-left:auto; margin-right:auto; font-size: 12px;color: #666666;">
								...
								<tr>
									<td style="width: 142px; height: 32px; background-color:#FFFFFF; text-align: left;" >&nbsp;<strong>Ref. Estimatif :</strong></td>
									...
									<td colspan="2" style="height: 32px; background-color:#E7E7E7; text-align: left; vertical-align: middle; border-radius: 8px;-moz-border-radius: 8px;">&nbsp;
										<input name="input_RefDevis" id="input_RefDevis" type="text" size="30" style="border: 0; font-size: 12px;color: #666666;background-color:transparent;vertical-align:top;" value="xxxx" onclick="javascript:if(document.getElementById('input_RefDevis').value == 'xxxx') {document.getElementById('input_RefDevis').value ='';};"/>
									</td>
									<td style="width: 142px; height: 32px; background-color:#FFFFFF; text-align: left;">&nbsp;<strong>Date Estimatif :</strong></td>
									...
									<td style="width: 142px; height: 32px; background-color:#FFFFFF; text-align: left;">
										<fieldset style="border:0; font-size: 12px;">
											...
											foreach ($pdo_sql  as $key_sql  => $pdo_lignes_sql) {
												echo '<option value="'.$pdo_lignes_sql['E0_000_idSql'].'">'.$pdo_lignes_sql['E0_001_Taux_TVA'].' %</option>';
											}
											?>
											</select>
										</fieldset>
							...
							<table style="border: 0px solid; background-color:#FFFFFF; padding: 0px; width:1000px; margin-left:auto; margin-right:auto; font-size: 12px;color: #666666;">
								...
								<tr>
									<td colspan="7" style="height: 32px;">
										...
										<div style="margin-top: 10px;float:left" id="radioTrx4">&nbsp;Maintenance</div>
										<div style="margin-top: 10px;float:left" id="radioTrx5">&nbsp;Inventaire</div>
									</td>
								</tr>
								<tr>
									<td colspan="7">
										<input name="input_EtudTrx" id="input_EtudTrx" type="hidden" size="80" style="border: 1px; font-size: 12px;color: #666666;background-color:transparent;" value="Trav" />
									</td>
								</tr>
								<tr>
									...
									<td style="width: 142px; height: 32px; background-color:#FFFFFF; text-align: left; ">
										<fieldset style="border:0; font-size: 12px;">
											<select name="SelectTypUPEP" id="SelectTypUPEP">
												...
												<option value="UPEP_E">Etude</option>
											</select>
										</fieldset>
                                    </td>
                                ...
                                <div id="Textejustifdepas" style="font-size: 12px;color: #666666;display:none;">
                                    <table style="border: 0px solid; background-color:#FFFFFF; padding: 0px; width:1000px; margin-left:auto; margin-right:auto; font-size: 12px;color: #666666;">
                                        ...
                                        <tr>
                                            <td style="width: 142px; background-color:#FFFFFF;"></td>
                                            <td colspan="7" style="height: 32px; vertical-align: middle; ">
                                                <textarea name="DetailTextejustifdepas" id="DetailTextejustifdepas" rows="10" cols="100" style="font-size: 12px;color: #666666;display:none;" onclick="javascript:if(document.getElementById('DetailTextejustifdepas').value == 'Renseignez ici les MIP à utiliser pour l\'auto financement') {document.getElementById('DetailTextejustifdepas').value ='';};">Renseignez ici les MIP à utiliser pour l'auto financement</textarea>
                                            </td>
                                       </tr>
                                	</table>
							...
							<tr style="text-align: center">
								...
								<td style="width: 400px; text-align: right; vertical-align: middle;">
									<div id="show_Bt_enreg" style="display:none;">
										...
										<input type="hidden" name="SuiviMail" id="SuiviMail" value="N">
									</div>
								</td>
							</tr>
							<tr style="height: 5px">
